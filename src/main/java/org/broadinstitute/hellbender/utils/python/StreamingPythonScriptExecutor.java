 ...
 *  - optionally send data one or more times through the async writer
...
public class StreamingPythonScriptExecutor extends PythonExecutorBase {
    ...
    public <T> AsynchronousStreamWriter<T> getStreamWriter(final Function<T, ByteArrayOutputStream> itemSerializer) {
        ...
        try {
            ...
            final AsynchronousStreamWriter<T> asyncWriter =
                    spController.getAsynchronousStreamWriter(dataTransferFIFOWriter, itemSerializer);
