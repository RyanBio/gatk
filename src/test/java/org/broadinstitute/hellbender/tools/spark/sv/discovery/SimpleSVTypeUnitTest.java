...
public class SimpleSVTypeUnitTest extends GATKBaseTest {
    ...
    public static void testAltAlleleSvLenAndIdProductions_stable(final NovelAdjacencyAndAltHaplotype novelAdjacencyReferenceLocations,
        ...
        final List<Allele> producedAlleles = AnnotatedVariantProducer.produceAlleles(novelAdjacencyReferenceLocations.getLeftJustifiedLeftRefLoc(), TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, simpleType);
    ...
    private Object[][] forAltAlleleSvLenAndIdProductions_new() {
        ...
        // simple deletion
        data.add(new Object[]{forSimpleDeletion_plus.biPathBubble, forSimpleDeletion_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -20, DEL.name()});

        // simple insertion
        data.add(new Object[]{forSimpleInsertion_minus.biPathBubble, forSimpleInsertion_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_INS, 50, INS.name()});

        // long range substitution fudged del
        data.add(new Object[]{forLongRangeSubstitution_fudgedDel_plus.biPathBubble, forLongRangeSubstitution_fudgedDel_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -60, DEL.name()});

        // long range substitution fat ins
        data.add(new Object[]{forLongRangeSubstitution_fatIns_minus.biPathBubble, forLongRangeSubstitution_fatIns_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_INS, 60, INS.name()});

        // long range substitution fat ins
        List<SvType> svTypes = forLongRangeSubstitution_DelAndIns_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21);
        ...
        // simple deletion with homology
        data.add(new Object[]{forDeletionWithHomology_minus.biPathBubble, forDeletionWithHomology_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -38, DEL.name()});

        // simple tandem dup contraction from 2 units to 1 unit
        data.add(new Object[]{forSimpleTanDupContraction_plus.biPathBubble, forSimpleTanDupContraction_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -10,
                DUP_TAN_CONTRACTION_INTERNAL_ID_START_STRING});

        // simple tandem dup expansion from 1 unit to 2 units that will be called as insertion
        data.add(new Object[]{forSimpleTanDupExpansion_ins_minus.biPathBubble, forSimpleTanDupExpansion_ins_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_INS, 10,
                INS.name()});

        // simple tandem dup expansion from 1 unit to 2 units that will be called as duplication
        data.add(new Object[]{forSimpleTanDupExpansion_dup_minus.biPathBubble, forSimpleTanDupExpansion_dup_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
        ...
        data.add(new Object[]{forSimpleTanDupExpansionWithNovelIns_ins_plus.biPathBubble, forSimpleTanDupExpansionWithNovelIns_ins_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
        ...
        data.add(new Object[]{forSimpleTanDupExpansionWithNovelIns_dup_plus.biPathBubble, forSimpleTanDupExpansionWithNovelIns_dup_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DUP, 99,
                DUP_TAN_EXPANSION_INTERNAL_ID_START_STRING});

        // tandem dup expansion from 1 unit to 2 units with pseudo-homology
        data.add(new Object[]{forComplexTanDup_1to2_pseudoHom_minus.biPathBubble, forComplexTanDup_1to2_pseudoHom_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DUP, 96,
                DUP_TAN_EXPANSION_INTERNAL_ID_START_STRING});

        // tandem dup contraction from 2 units to 1 unit with pseudo-homology
        data.add(new Object[]{forComplexTanDup_2to1_pseudoHom_plus.biPathBubble, forComplexTanDup_2to1_pseudoHom_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -96,
                DUP_TAN_CONTRACTION_INTERNAL_ID_START_STRING});


        // tandem dup contraction from 3 units to 2 units
        data.add(new Object[]{forComplexTanDup_3to2_noPseudoHom_minus.biPathBubble, forComplexTanDup_3to2_noPseudoHom_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DEL, -96,
                DUP_TAN_CONTRACTION_INTERNAL_ID_START_STRING});

        // tandem dup expansion from 2 units to 3 units
        data.add(new Object[]{forComplexTanDup_2to3_noPseudoHom_plus.biPathBubble, forComplexTanDup_2to3_noPseudoHom_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_DUP, 96,
                DUP_TAN_EXPANSION_INTERNAL_ID_START_STRING});

        // short tandem dup expansion from 1 unit to 2 units with pseudo-homology
        data.add(new Object[]{forComplexTanDup_1to2_short_pseudoHom_plus.biPathBubble, forComplexTanDup_1to2_short_pseudoHom_plus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_INS, 42,
                INS.name()});
        // short tandem dup expansion from 2 units to 3 units
        data.add(new Object[]{forComplexTanDup_2to3_short_noPseudoHom_minus.biPathBubble, forComplexTanDup_2to3_short_noPseudoHom_minus.biPathBubble.toSimpleOrBNDTypes(TestUtilsForAssemblyBasedSVDiscovery.b37_reference_20_21, TestUtilsForAssemblyBasedSVDiscovery.b37_seqDict_20_21).get(0),
                SYMB_ALT_ALLELE_INS, 42,
                INS.name()});
